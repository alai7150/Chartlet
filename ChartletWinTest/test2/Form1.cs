...
namespace test2
{
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            ...
            dt.Columns.Add("Jesy", typeof(float));
            dt.Columns.Add("Bob", typeof(float));
            dt.Columns.Add("Jeson", typeof(float));
            dt.Rows.Add(new object[] { "Spring", 120, 82, 119 });
            dt.Rows.Add(new object[] { "Summer", 100, 97, 106 });
            dt.Rows.Add(new object[] { "Autum", 80, 72, 81 });
            dt.Rows.Add(new object[] { "Winter", 101, 118, 108 });
