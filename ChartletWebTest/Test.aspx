...
<body style="font-size:15pt; font-family:Arial;">
    ...
    <div>
        <cc1:Chartlet ID="Chartlet3" runat="server" GroupSize="2" Shadow-Radius="5"
            FillColor1="Purple"/>
            
        <cc1:Chartlet ID="Chartlet4" runat="server" GroupSize="2" Shadow-Enable="true" Shadow-Distance="8" Shadow-Radius="10"
